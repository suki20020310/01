...
// ==============================================================
`timescale 1ns/1ps
module downsample_block_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_H_IN_DATA_0         = 9'h018,
    ADDR_H_IN_CTRL           = 9'h01c,
    ADDR_H_OUT_DATA_0        = 9'h020,
    ADDR_H_OUT_CTRL          = 9'h024,
    ADDR_STRIDE_DATA_0       = 9'h028,
    ADDR_STRIDE_CTRL         = 9'h02c,
    ADDR_IN_R_DATA_0         = 9'h030,
    ADDR_IN_R_DATA_1         = 9'h034,
    ADDR_IN_R_CTRL           = 9'h038,
    ADDR_DW_KERNEL_DATA_0    = 9'h03c,
    ADDR_DW_KERNEL_DATA_1    = 9'h040,
    ADDR_DW_KERNEL_CTRL      = 9'h044,
    ADDR_CONV1_KERNEL_DATA_0 = 9'h048,
    ADDR_CONV1_KERNEL_DATA_1 = 9'h04c,
    ADDR_CONV1_KERNEL_CTRL   = 9'h050,
    ADDR_CONV2_KERNEL_DATA_0 = 9'h054,
    ADDR_CONV2_KERNEL_DATA_1 = 9'h058,
    ADDR_CONV2_KERNEL_CTRL   = 9'h05c,
    ADDR_BN1_MEAN_DATA_0     = 9'h060,
    ADDR_BN1_MEAN_DATA_1     = 9'h064,
    ADDR_BN1_MEAN_CTRL       = 9'h068,
    ADDR_BN1_VAR_DATA_0      = 9'h06c,
    ADDR_BN1_VAR_DATA_1      = 9'h070,
    ADDR_BN1_VAR_CTRL        = 9'h074,
    ADDR_BN1_GAMMA_DATA_0    = 9'h078,
    ADDR_BN1_GAMMA_DATA_1    = 9'h07c,
    ADDR_BN1_GAMMA_CTRL      = 9'h080,
    ADDR_BN1_BETA_DATA_0     = 9'h084,
    ADDR_BN1_BETA_DATA_1     = 9'h088,
    ADDR_BN1_BETA_CTRL       = 9'h08c,
    ADDR_BN2_MEAN_DATA_0     = 9'h090,
    ADDR_BN2_MEAN_DATA_1     = 9'h094,
    ADDR_BN2_MEAN_CTRL       = 9'h098,
    ADDR_BN2_VAR_DATA_0      = 9'h09c,
    ADDR_BN2_VAR_DATA_1      = 9'h0a0,
    ADDR_BN2_VAR_CTRL        = 9'h0a4,
    ADDR_BN2_GAMMA_DATA_0    = 9'h0a8,
    ADDR_BN2_GAMMA_DATA_1    = 9'h0ac,
    ADDR_BN2_GAMMA_CTRL      = 9'h0b0,
    ADDR_BN2_BETA_DATA_0     = 9'h0b4,
    ADDR_BN2_BETA_DATA_1     = 9'h0b8,
    ADDR_BN2_BETA_CTRL       = 9'h0bc,
    ADDR_BN3_MEAN_DATA_0     = 9'h0c0,
    ADDR_BN3_MEAN_DATA_1     = 9'h0c4,
    ADDR_BN3_MEAN_CTRL       = 9'h0c8,
    ADDR_BN3_VAR_DATA_0      = 9'h0cc,
    ADDR_BN3_VAR_DATA_1      = 9'h0d0,
    ADDR_BN3_VAR_CTRL        = 9'h0d4,
    ADDR_BN3_GAMMA_DATA_0    = 9'h0d8,
    ADDR_BN3_GAMMA_DATA_1    = 9'h0dc,
    ADDR_BN3_GAMMA_CTRL      = 9'h0e0,
    ADDR_BN3_BETA_DATA_0     = 9'h0e4,
    ADDR_BN3_BETA_DATA_1     = 9'h0e8,
    ADDR_BN3_BETA_CTRL       = 9'h0ec,
    ADDR_OUT_R_DATA_0        = 9'h0f0,
    ADDR_OUT_R_DATA_1        = 9'h0f4,
    ADDR_OUT_R_CTRL          = 9'h0f8,
    ADDR_C_OUT_DATA_0        = 9'h0fc,
    ADDR_C_OUT_CTRL          = 9'h100,
    ADDR_W_IN_DATA_0         = 9'h104,
    ADDR_W_IN_CTRL           = 9'h108,
    ADDR_W_OUT_DATA_0        = 9'h10c,
    ADDR_W_OUT_CTRL          = 9'h110,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_H_OUT_DATA_0)
            int_h_out[15:0] <= (WDATA[31:0] & wmask) | (int_h_out[15:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_W_OUT_DATA_0)
            int_w_out[15:0] <= (WDATA[31:0] & wmask) | (int_w_out[15:0] & ~wmask);
    end
end
