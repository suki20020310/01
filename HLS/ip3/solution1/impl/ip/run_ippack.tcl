...
set Library     "hls"
set IPName      "downsample_block"
set Version     "1.0"
set DisplayName "Downsample_block"
set Revision    "2114326419"
...
set xo_kernel_name "downsample_block"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/11400/Desktop/shuffle/HLS/ip3/solution1"
set debug_dir "C:/Users/11400/Desktop/shuffle/HLS/ip3/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {downsample_block_mul_32s_16ns_32_1_1
downsample_block_udiv_17s_8ns_17_21_1
downsample_block_srem_33ns_17s_5_37_1
downsample_block_mul_8s_8s_16_1_1
downsample_block_mul_32s_32s_32_1_1
downsample_block_mul_32s_15ns_32_1_1
downsample_block_mul_17ns_32s_32_1_1
downsample_block_mul_9s_8s_17_1_1
downsample_block_mul_32s_17ns_32_1_1
downsample_block_mul_32ns_16ns_48_1_1
downsample_block_mul_mul_16ns_16ns_32_4_1
downsample_block_mul_mul_16ns_8ns_24_4_1
downsample_block_mac_muladd_8s_8s_8ns_8_4_1
downsample_block_am_submul_8s_8s_8s_17_4_1
downsample_block_mul_mul_17s_17ns_33_4_1
downsample_block_mul_mul_17s_16ns_33_4_1
downsample_block_mac_muladd_8s_8s_16s_17_4_1
downsample_block_mac_muladd_8s_8s_17s_17_4_1
downsample_block_mac_muladd_8s_8s_17s_18_4_1
downsample_block_mac_muladd_8s_8s_18s_18_4_1
downsample_block_mac_muladd_8s_8s_18s_19_4_1
downsample_block_mac_muladd_8s_8s_19s_19_4_1
downsample_block_am_submul_11s_8s_8s_20_4_1
downsample_block_mul_mul_20s_17ns_32_4_1
downsample_block_mac_muladd_16ns_16ns_16ns_32_4_1
downsample_block_am_addmul_16ns_1ns_16ns_32_4_1
downsample_block_mul_mul_17s_16ns_32_4_1
downsample_block_mini_buffer_V_RAM_S2P_BRAM_1R1W
downsample_block_gmem2_m_axi
downsample_block_control_s_axi
downsample_block
}
set kernel_xo ""

## Variables
set Top "downsample_block"
set TopNoPrefix "downsample_block"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 c_in W 0x0 "Data signal of c_in" {{0 16 c_in W 0 "Bit 15 to 0 of c_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 h_in W 0x0 "Data signal of h_in" {{0 16 h_in W 0 "Bit 15 to 0 of h_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 h_out W 0x0 "Data signal of h_out" {{0 16 h_out W 0 "Bit 15 to 0 of h_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 stride W 0x0 "Data signal of stride" {{0 8 stride W 0 "Bit 7 to 0 of stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 in_r_1 W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 31 to 0 of in_r"}}} {0x34 in_r_2 W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 63 to 32 of in_r"}}} {0x3c dw_kernel_1 W 0x0 "Data signal of dw_kernel" {{0 32 dw_kernel W 0 "Bit 31 to 0 of dw_kernel"}}} {0x40 dw_kernel_2 W 0x0 "Data signal of dw_kernel" {{0 32 dw_kernel W 0 "Bit 63 to 32 of dw_kernel"}}} {0x48 conv1_kernel_1 W 0x0 "Data signal of conv1_kernel" {{0 32 conv1_kernel W 0 "Bit 31 to 0 of conv1_kernel"}}} {0x4c conv1_kernel_2 W 0x0 "Data signal of conv1_kernel" {{0 32 conv1_kernel W 0 "Bit 63 to 32 of conv1_kernel"}}} {0x54 conv2_kernel_1 W 0x0 "Data signal of conv2_kernel" {{0 32 conv2_kernel W 0 "Bit 31 to 0 of conv2_kernel"}}} {0x58 conv2_kernel_2 W 0x0 "Data signal of conv2_kernel" {{0 32 conv2_kernel W 0 "Bit 63 to 32 of conv2_kernel"}}} {0x60 bn1_mean_1 W 0x0 "Data signal of bn1_mean" {{0 32 bn1_mean W 0 "Bit 31 to 0 of bn1_mean"}}} {0x64 bn1_mean_2 W 0x0 "Data signal of bn1_mean" {{0 32 bn1_mean W 0 "Bit 63 to 32 of bn1_mean"}}} {0x6c bn1_var_1 W 0x0 "Data signal of bn1_var" {{0 32 bn1_var W 0 "Bit 31 to 0 of bn1_var"}}} {0x70 bn1_var_2 W 0x0 "Data signal of bn1_var" {{0 32 bn1_var W 0 "Bit 63 to 32 of bn1_var"}}} {0x78 bn1_gamma_1 W 0x0 "Data signal of bn1_gamma" {{0 32 bn1_gamma W 0 "Bit 31 to 0 of bn1_gamma"}}} {0x7c bn1_gamma_2 W 0x0 "Data signal of bn1_gamma" {{0 32 bn1_gamma W 0 "Bit 63 to 32 of bn1_gamma"}}} {0x84 bn1_beta_1 W 0x0 "Data signal of bn1_beta" {{0 32 bn1_beta W 0 "Bit 31 to 0 of bn1_beta"}}} {0x88 bn1_beta_2 W 0x0 "Data signal of bn1_beta" {{0 32 bn1_beta W 0 "Bit 63 to 32 of bn1_beta"}}} {0x90 bn2_mean_1 W 0x0 "Data signal of bn2_mean" {{0 32 bn2_mean W 0 "Bit 31 to 0 of bn2_mean"}}} {0x94 bn2_mean_2 W 0x0 "Data signal of bn2_mean" {{0 32 bn2_mean W 0 "Bit 63 to 32 of bn2_mean"}}} {0x9c bn2_var_1 W 0x0 "Data signal of bn2_var" {{0 32 bn2_var W 0 "Bit 31 to 0 of bn2_var"}}} {0xa0 bn2_var_2 W 0x0 "Data signal of bn2_var" {{0 32 bn2_var W 0 "Bit 63 to 32 of bn2_var"}}} {0xa8 bn2_gamma_1 W 0x0 "Data signal of bn2_gamma" {{0 32 bn2_gamma W 0 "Bit 31 to 0 of bn2_gamma"}}} {0xac bn2_gamma_2 W 0x0 "Data signal of bn2_gamma" {{0 32 bn2_gamma W 0 "Bit 63 to 32 of bn2_gamma"}}} {0xb4 bn2_beta_1 W 0x0 "Data signal of bn2_beta" {{0 32 bn2_beta W 0 "Bit 31 to 0 of bn2_beta"}}} {0xb8 bn2_beta_2 W 0x0 "Data signal of bn2_beta" {{0 32 bn2_beta W 0 "Bit 63 to 32 of bn2_beta"}}} {0xc0 bn3_mean_1 W 0x0 "Data signal of bn3_mean" {{0 32 bn3_mean W 0 "Bit 31 to 0 of bn3_mean"}}} {0xc4 bn3_mean_2 W 0x0 "Data signal of bn3_mean" {{0 32 bn3_mean W 0 "Bit 63 to 32 of bn3_mean"}}} {0xcc bn3_var_1 W 0x0 "Data signal of bn3_var" {{0 32 bn3_var W 0 "Bit 31 to 0 of bn3_var"}}} {0xd0 bn3_var_2 W 0x0 "Data signal of bn3_var" {{0 32 bn3_var W 0 "Bit 63 to 32 of bn3_var"}}} {0xd8 bn3_gamma_1 W 0x0 "Data signal of bn3_gamma" {{0 32 bn3_gamma W 0 "Bit 31 to 0 of bn3_gamma"}}} {0xdc bn3_gamma_2 W 0x0 "Data signal of bn3_gamma" {{0 32 bn3_gamma W 0 "Bit 63 to 32 of bn3_gamma"}}} {0xe4 bn3_beta_1 W 0x0 "Data signal of bn3_beta" {{0 32 bn3_beta W 0 "Bit 31 to 0 of bn3_beta"}}} {0xe8 bn3_beta_2 W 0x0 "Data signal of bn3_beta" {{0 32 bn3_beta W 0 "Bit 63 to 32 of bn3_beta"}}} {0xf0 out_r_1 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 of out_r"}}} {0xf4 out_r_2 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 63 to 32 of out_r"}}} {0xfc c_out W 0x0 "Data signal of c_out" {{0 16 c_out W 0 "Bit 15 to 0 of c_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x104 w_in W 0x0 "Data signal of w_in" {{0 16 w_in W 0 "Bit 15 to 0 of w_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x10c w_out W 0x0 "Data signal of w_out" {{0 16 w_out W 0 "Bit 15 to 0 of w_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
