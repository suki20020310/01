...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "shufflenet_block.autotvin.dat"
	set constFileTvOut       "shufflenet_block.autotvout.dat"
	set constFileHdlTvIn     "shufflenet_block.autohdltvin.dat"
	set constFileHdlTvOut    "shufflenet_block.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
