...
$(ObjDir)/test_channel_shuffle.cpp_pre.cpp.tb.o : test_channel_shuffle.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_channel_shuffle.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/channel_shuffle.cpp_pre.cpp.tb.o : channel_shuffle.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling channel_shuffle.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
