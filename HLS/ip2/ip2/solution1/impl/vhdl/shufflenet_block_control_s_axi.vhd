...
entity shufflenet_block_control_s_axi is
generic (
...
end entity shufflenet_block_control_s_axi;
...
architecture behave of shufflenet_block_control_s_axi is
    ...
    constant ADDR_H_W_DATA_0          : INTEGER := 16#018#;
    constant ADDR_H_W_CTRL            : INTEGER := 16#01c#;
    constant ADDR_STRIDE_DATA_0       : INTEGER := 16#020#;
    constant ADDR_STRIDE_CTRL         : INTEGER := 16#024#;
    constant ADDR_IN_R_DATA_0         : INTEGER := 16#028#;
    constant ADDR_IN_R_DATA_1         : INTEGER := 16#02c#;
    constant ADDR_IN_R_CTRL           : INTEGER := 16#030#;
    constant ADDR_CONV1_KERNEL_DATA_0 : INTEGER := 16#034#;
    constant ADDR_CONV1_KERNEL_DATA_1 : INTEGER := 16#038#;
    constant ADDR_CONV1_KERNEL_CTRL   : INTEGER := 16#03c#;
    constant ADDR_DW_KERNEL_DATA_0    : INTEGER := 16#040#;
    constant ADDR_DW_KERNEL_DATA_1    : INTEGER := 16#044#;
    constant ADDR_DW_KERNEL_CTRL      : INTEGER := 16#048#;
    constant ADDR_CONV2_KERNEL_DATA_0 : INTEGER := 16#04c#;
    constant ADDR_CONV2_KERNEL_DATA_1 : INTEGER := 16#050#;
    constant ADDR_CONV2_KERNEL_CTRL   : INTEGER := 16#054#;
    constant ADDR_BN1_MEAN_DATA_0     : INTEGER := 16#058#;
    constant ADDR_BN1_MEAN_DATA_1     : INTEGER := 16#05c#;
    constant ADDR_BN1_MEAN_CTRL       : INTEGER := 16#060#;
    constant ADDR_BN1_VAR_DATA_0      : INTEGER := 16#064#;
    constant ADDR_BN1_VAR_DATA_1      : INTEGER := 16#068#;
    constant ADDR_BN1_VAR_CTRL        : INTEGER := 16#06c#;
    constant ADDR_BN1_GAMMA_DATA_0    : INTEGER := 16#070#;
    constant ADDR_BN1_GAMMA_DATA_1    : INTEGER := 16#074#;
    constant ADDR_BN1_GAMMA_CTRL      : INTEGER := 16#078#;
    constant ADDR_BN1_BETA_DATA_0     : INTEGER := 16#07c#;
    constant ADDR_BN1_BETA_DATA_1     : INTEGER := 16#080#;
    constant ADDR_BN1_BETA_CTRL       : INTEGER := 16#084#;
    constant ADDR_BN2_MEAN_DATA_0     : INTEGER := 16#088#;
    constant ADDR_BN2_MEAN_DATA_1     : INTEGER := 16#08c#;
    constant ADDR_BN2_MEAN_CTRL       : INTEGER := 16#090#;
    constant ADDR_BN2_VAR_DATA_0      : INTEGER := 16#094#;
    constant ADDR_BN2_VAR_DATA_1      : INTEGER := 16#098#;
    constant ADDR_BN2_VAR_CTRL        : INTEGER := 16#09c#;
    constant ADDR_BN2_GAMMA_DATA_0    : INTEGER := 16#0a0#;
    constant ADDR_BN2_GAMMA_DATA_1    : INTEGER := 16#0a4#;
    constant ADDR_BN2_GAMMA_CTRL      : INTEGER := 16#0a8#;
    constant ADDR_BN2_BETA_DATA_0     : INTEGER := 16#0ac#;
    constant ADDR_BN2_BETA_DATA_1     : INTEGER := 16#0b0#;
    constant ADDR_BN2_BETA_CTRL       : INTEGER := 16#0b4#;
    constant ADDR_BN3_MEAN_DATA_0     : INTEGER := 16#0b8#;
    constant ADDR_BN3_MEAN_DATA_1     : INTEGER := 16#0bc#;
    constant ADDR_BN3_MEAN_CTRL       : INTEGER := 16#0c0#;
    constant ADDR_BN3_VAR_DATA_0      : INTEGER := 16#0c4#;
    constant ADDR_BN3_VAR_DATA_1      : INTEGER := 16#0c8#;
    constant ADDR_BN3_VAR_CTRL        : INTEGER := 16#0cc#;
    constant ADDR_BN3_GAMMA_DATA_0    : INTEGER := 16#0d0#;
    constant ADDR_BN3_GAMMA_DATA_1    : INTEGER := 16#0d4#;
    constant ADDR_BN3_GAMMA_CTRL      : INTEGER := 16#0d8#;
    constant ADDR_BN3_BETA_DATA_0     : INTEGER := 16#0dc#;
    constant ADDR_BN3_BETA_DATA_1     : INTEGER := 16#0e0#;
    constant ADDR_BN3_BETA_CTRL       : INTEGER := 16#0e4#;
    constant ADDR_OUT_R_DATA_0        : INTEGER := 16#0e8#;
    constant ADDR_OUT_R_DATA_1        : INTEGER := 16#0ec#;
    constant ADDR_OUT_R_CTRL          : INTEGER := 16#0f0#;
    constant ADDR_C_OUT_DATA_0        : INTEGER := 16#0f4#;
    constant ADDR_C_OUT_CTRL          : INTEGER := 16#0f8#;
    constant ADDR_C_REDUCE_DATA_0     : INTEGER := 16#0fc#;
    constant ADDR_C_REDUCE_CTRL       : INTEGER := 16#100#;
    ...
    signal int_c_reduce        : UNSIGNED(15 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_C_REDUCE_DATA_0 =>
                        rdata_data <= RESIZE(int_c_reduce(15 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    c_reduce             <= STD_LOGIC_VECTOR(int_c_reduce);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_C_REDUCE_DATA_0) then
                    int_c_reduce(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_c_reduce(15 downto 0));
                end if;
            end if;
        end if;
    end process;
