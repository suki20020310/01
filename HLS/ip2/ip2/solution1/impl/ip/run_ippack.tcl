...
set Library     "hls"
set IPName      "shufflenet_block"
set Version     "1.0"
set DisplayName "Shufflenet_block"
set Revision    "2114326373"
...
set xo_kernel_name "shufflenet_block"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/11400/Desktop/shuffle/HLS/ip2/ip2/solution1"
set debug_dir "C:/Users/11400/Desktop/shuffle/HLS/ip2/ip2/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {shufflenet_block_mul_32s_16ns_32_1_1
shufflenet_block_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "shufflenet_block"
set TopNoPrefix "shufflenet_block"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 c_in W 0x0 "Data signal of c_in" {{0 16 c_in W 0 "Bit 15 to 0 of c_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 h_w W 0x0 "Data signal of h_w" {{0 16 h_w W 0 "Bit 15 to 0 of h_w"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 stride W 0x0 "Data signal of stride" {{0 8 stride W 0 "Bit 7 to 0 of stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 in_r_1 W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 31 to 0 of in_r"}}} {0x2c in_r_2 W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 63 to 32 of in_r"}}} {0x34 conv1_kernel_1 W 0x0 "Data signal of conv1_kernel" {{0 32 conv1_kernel W 0 "Bit 31 to 0 of conv1_kernel"}}} {0x38 conv1_kernel_2 W 0x0 "Data signal of conv1_kernel" {{0 32 conv1_kernel W 0 "Bit 63 to 32 of conv1_kernel"}}} {0x40 dw_kernel_1 W 0x0 "Data signal of dw_kernel" {{0 32 dw_kernel W 0 "Bit 31 to 0 of dw_kernel"}}} {0x44 dw_kernel_2 W 0x0 "Data signal of dw_kernel" {{0 32 dw_kernel W 0 "Bit 63 to 32 of dw_kernel"}}} {0x4c conv2_kernel_1 W 0x0 "Data signal of conv2_kernel" {{0 32 conv2_kernel W 0 "Bit 31 to 0 of conv2_kernel"}}} {0x50 conv2_kernel_2 W 0x0 "Data signal of conv2_kernel" {{0 32 conv2_kernel W 0 "Bit 63 to 32 of conv2_kernel"}}} {0x58 bn1_mean_1 W 0x0 "Data signal of bn1_mean" {{0 32 bn1_mean W 0 "Bit 31 to 0 of bn1_mean"}}} {0x5c bn1_mean_2 W 0x0 "Data signal of bn1_mean" {{0 32 bn1_mean W 0 "Bit 63 to 32 of bn1_mean"}}} {0x64 bn1_var_1 W 0x0 "Data signal of bn1_var" {{0 32 bn1_var W 0 "Bit 31 to 0 of bn1_var"}}} {0x68 bn1_var_2 W 0x0 "Data signal of bn1_var" {{0 32 bn1_var W 0 "Bit 63 to 32 of bn1_var"}}} {0x70 bn1_gamma_1 W 0x0 "Data signal of bn1_gamma" {{0 32 bn1_gamma W 0 "Bit 31 to 0 of bn1_gamma"}}} {0x74 bn1_gamma_2 W 0x0 "Data signal of bn1_gamma" {{0 32 bn1_gamma W 0 "Bit 63 to 32 of bn1_gamma"}}} {0x7c bn1_beta_1 W 0x0 "Data signal of bn1_beta" {{0 32 bn1_beta W 0 "Bit 31 to 0 of bn1_beta"}}} {0x80 bn1_beta_2 W 0x0 "Data signal of bn1_beta" {{0 32 bn1_beta W 0 "Bit 63 to 32 of bn1_beta"}}} {0x88 bn2_mean_1 W 0x0 "Data signal of bn2_mean" {{0 32 bn2_mean W 0 "Bit 31 to 0 of bn2_mean"}}} {0x8c bn2_mean_2 W 0x0 "Data signal of bn2_mean" {{0 32 bn2_mean W 0 "Bit 63 to 32 of bn2_mean"}}} {0x94 bn2_var_1 W 0x0 "Data signal of bn2_var" {{0 32 bn2_var W 0 "Bit 31 to 0 of bn2_var"}}} {0x98 bn2_var_2 W 0x0 "Data signal of bn2_var" {{0 32 bn2_var W 0 "Bit 63 to 32 of bn2_var"}}} {0xa0 bn2_gamma_1 W 0x0 "Data signal of bn2_gamma" {{0 32 bn2_gamma W 0 "Bit 31 to 0 of bn2_gamma"}}} {0xa4 bn2_gamma_2 W 0x0 "Data signal of bn2_gamma" {{0 32 bn2_gamma W 0 "Bit 63 to 32 of bn2_gamma"}}} {0xac bn2_beta_1 W 0x0 "Data signal of bn2_beta" {{0 32 bn2_beta W 0 "Bit 31 to 0 of bn2_beta"}}} {0xb0 bn2_beta_2 W 0x0 "Data signal of bn2_beta" {{0 32 bn2_beta W 0 "Bit 63 to 32 of bn2_beta"}}} {0xb8 bn3_mean_1 W 0x0 "Data signal of bn3_mean" {{0 32 bn3_mean W 0 "Bit 31 to 0 of bn3_mean"}}} {0xbc bn3_mean_2 W 0x0 "Data signal of bn3_mean" {{0 32 bn3_mean W 0 "Bit 63 to 32 of bn3_mean"}}} {0xc4 bn3_var_1 W 0x0 "Data signal of bn3_var" {{0 32 bn3_var W 0 "Bit 31 to 0 of bn3_var"}}} {0xc8 bn3_var_2 W 0x0 "Data signal of bn3_var" {{0 32 bn3_var W 0 "Bit 63 to 32 of bn3_var"}}} {0xd0 bn3_gamma_1 W 0x0 "Data signal of bn3_gamma" {{0 32 bn3_gamma W 0 "Bit 31 to 0 of bn3_gamma"}}} {0xd4 bn3_gamma_2 W 0x0 "Data signal of bn3_gamma" {{0 32 bn3_gamma W 0 "Bit 63 to 32 of bn3_gamma"}}} {0xdc bn3_beta_1 W 0x0 "Data signal of bn3_beta" {{0 32 bn3_beta W 0 "Bit 31 to 0 of bn3_beta"}}} {0xe0 bn3_beta_2 W 0x0 "Data signal of bn3_beta" {{0 32 bn3_beta W 0 "Bit 63 to 32 of bn3_beta"}}} {0xe8 out_r_1 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 of out_r"}}} {0xec out_r_2 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 63 to 32 of out_r"}}} {0xf4 c_out W 0x0 "Data signal of c_out" {{0 16 c_out W 0 "Bit 15 to 0 of c_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xfc c_reduce W 0x0 "Data signal of c_reduce" {{0 16 c_reduce W 0 "Bit 15 to 0 of c_reduce"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem_in m_axi_gmem_weights1 m_axi_gmem_weights2 m_axi_gmem_weights3 m_axi_gmem_bn1 m_axi_gmem_bn2 m_axi_gmem_bn3 m_axi_gmem_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem_weights1 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_weights1"
        param_prefix "C_M_AXI_GMEM_WEIGHTS1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_gmem_weights2 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_weights2"
        param_prefix "C_M_AXI_GMEM_WEIGHTS2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_gmem_weights3 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_weights3"
        param_prefix "C_M_AXI_GMEM_WEIGHTS3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_gmem_bn1 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_bn1"
        param_prefix "C_M_AXI_GMEM_BN1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_gmem_bn2 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_bn2"
        param_prefix "C_M_AXI_GMEM_BN2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_gmem_bn3 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_bn3"
        param_prefix "C_M_AXI_GMEM_BN3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
