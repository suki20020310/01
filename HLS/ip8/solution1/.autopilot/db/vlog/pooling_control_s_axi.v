...
localparam
    ...
    ADDR_IER                = 7'h08,
    ADDR_ISR                = 7'h0c,
    ADDR_C_IN_DATA_0        = 7'h10,
    ADDR_C_IN_CTRL          = 7'h14,
    ADDR_W_IN_DATA_0        = 7'h18,
    ADDR_W_IN_CTRL          = 7'h1c,
    ADDR_STRIDE_DATA_0      = 7'h20,
    ADDR_STRIDE_CTRL        = 7'h24,
    ADDR_POOL_TYPE_DATA_0   = 7'h28,
    ADDR_POOL_TYPE_CTRL     = 7'h2c,
    ADDR_H_IN_DATA_0        = 7'h30,
    ADDR_H_IN_CTRL          = 7'h34,
    ADDR_KERNEL_SIZE_DATA_0 = 7'h38,
    ADDR_KERNEL_SIZE_CTRL   = 7'h3c,
    ADDR_PADDING_DATA_0     = 7'h40,
    ADDR_PADDING_CTRL       = 7'h44,
    ADDR_FEATURE_IN_DATA_0  = 7'h48,
    ADDR_FEATURE_IN_DATA_1  = 7'h4c,
    ADDR_FEATURE_IN_CTRL    = 7'h50,
    ADDR_FEATURE_OUT_DATA_0 = 7'h54,
    ADDR_FEATURE_OUT_DATA_1 = 7'h58,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_POOL_TYPE_DATA_0: begin
                    rdata <= int_pool_type[0:0];
                end
...
assign pool_type         = int_pool_type;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_POOL_TYPE_DATA_0)
            int_pool_type[0:0] <= (WDATA[31:0] & wmask) | (int_pool_type[0:0] & ~wmask);
    end
end
