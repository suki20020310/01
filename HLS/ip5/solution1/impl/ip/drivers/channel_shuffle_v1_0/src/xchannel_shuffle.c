...
void XChannel_shuffle_Set_in_r(XChannel_shuffle *InstancePtr, u64 Data) {
    ...
    XChannel_shuffle_WriteReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_IN_R_DATA, (u32)(Data));
    XChannel_shuffle_WriteReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_IN_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XChannel_shuffle_Get_in_r(XChannel_shuffle *InstancePtr) {
    ...
    Data = XChannel_shuffle_ReadReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_IN_R_DATA);
    Data += (u64)XChannel_shuffle_ReadReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_IN_R_DATA + 4) << 32;
    return Data;
}
...
void XChannel_shuffle_Set_out_r(XChannel_shuffle *InstancePtr, u64 Data) {
    ...
    XChannel_shuffle_WriteReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_OUT_R_DATA, (u32)(Data));
    XChannel_shuffle_WriteReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_OUT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XChannel_shuffle_Get_out_r(XChannel_shuffle *InstancePtr) {
    ...
    Data = XChannel_shuffle_ReadReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_OUT_R_DATA);
    Data += (u64)XChannel_shuffle_ReadReg(InstancePtr->Control_r_BaseAddress, XCHANNEL_SHUFFLE_CONTROL_R_ADDR_OUT_R_DATA + 4) << 32;
    return Data;
}
