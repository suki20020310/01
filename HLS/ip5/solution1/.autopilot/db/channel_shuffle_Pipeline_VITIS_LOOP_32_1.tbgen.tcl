set moduleName channel_shuffle_Pipeline_VITIS_LOOP_32_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {channel_shuffle_Pipeline_VITIS_LOOP_32_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "mul_i467", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln32_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln32 sc_in sc_lv 62 signal 3 } 
	{ mul_i467 sc_in sc_lv 48 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_i467", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "mul_i467", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	mul_i467 { ap_none {  { mul_i467 in_data 0 48 } } }
}
