...
# 2 "<built-in>" 2
# 1 "../ip/ip6/channel_shuffle.cpp" 2
# 1 "../ip/ip6/channel_shuffle.h" 1
...
# 5 "../ip/ip6/channel_shuffle.h" 2


typedef float Dtype_f;
typedef float Dtype_w;
typedef double Dtype_acc;
# 24 "../ip/ip6/channel_shuffle.h"
__attribute__((sdx_kernel("channel_shuffle", 0))) void channel_shuffle(
    ap_uint<16> c_in,
    ap_uint<16> h_w,
    ap_uint<8> groups,
    Dtype_f* in,
...
# 2 "../ip/ip6/channel_shuffle.cpp" 2
# 12 "../ip/ip6/channel_shuffle.cpp"
__attribute__((sdx_kernel("channel_shuffle", 0))) void channel_shuffle(
    ap_uint<16> c_in,
    ap_uint<16> h_w,
    ap_uint<8> groups,
...
#line 16 "C:/Users/11400/Desktop/shuffletest/HLS/ip5/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=channel_shuffle
# 18 "../ip/ip6/channel_shuffle.cpp"

#line 6 "C:/Users/11400/Desktop/shuffletest/HLS/ip5/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=channel_shuffle
# 18 "../ip/ip6/channel_shuffle.cpp"


#pragma HLS INTERFACE m_axi port=in bundle=gmem_in depth=65536 offset=slave
#pragma HLS INTERFACE m_axi port=out bundle=gmem_out depth=65536 offset=slave


#pragma HLS INTERFACE s_axilite port=return bundle=control
#pragma HLS INTERFACE s_axilite port=c_in bundle=control offset=0x10
#pragma HLS INTERFACE s_axilite port=h_w bundle=control offset=0x20
#pragma HLS INTERFACE s_axilite port=groups bundle=control offset=0x18


 if (c_in % groups != 0) {

        VITIS_LOOP_32_1: for (ap_uint<32> i = 0; i < c_in * h_w * h_w; i++) {
            out[i] = in[i];
        }
        return;
    }
    ...
    VITIS_LOOP_43_2: for (ap_uint<16> h_block = 0; h_block < h_w; h_block += 8) {
        VITIS_LOOP_44_3: for (ap_uint<16> w_block = 0; w_block < h_w; w_block += 8) {
            VITIS_LOOP_45_4: for (ap_uint<16> h = h_block; h < h_block + 8 && h < h_w; h++) {
                VITIS_LOOP_46_5: for (ap_uint<16> w = w_block; w < w_block + 8 && w < h_w; w++) {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_48_6: for (ap_uint<8> g = 0; g < groups; g++) {
#pragma HLS UNROLL factor=4
 VITIS_LOOP_50_7: for (ap_uint<16> c = 0; c < group_ch; c++) {

                            ap_uint<16> in_c = g * group_ch + c;
                            ap_uint<32> in_idx = h * h_w * c_in + w * c_in + in_c;

                            ap_uint<16> out_c = c * groups + g;
                            ap_uint<32> out_idx = h * h_w * c_in + w * c_in + out_c;
