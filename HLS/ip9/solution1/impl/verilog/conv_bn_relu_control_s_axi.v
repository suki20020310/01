...
// ==============================================================
`timescale 1ns/1ps
module conv_bn_relu_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                = 8'h08,
    ADDR_ISR                = 8'h0c,
    ADDR_CONV_TYPE_DATA_0   = 8'h10,
    ADDR_CONV_TYPE_CTRL     = 8'h14,
    ADDR_H_IN_DATA_0        = 8'h18,
    ADDR_H_IN_CTRL          = 8'h1c,
    ADDR_C_OUT_DATA_0       = 8'h20,
    ADDR_C_OUT_CTRL         = 8'h24,
    ADDR_STRIDE_DATA_0      = 8'h28,
    ADDR_STRIDE_CTRL        = 8'h2c,
    ADDR_C_IN_DATA_0        = 8'h30,
    ADDR_C_IN_CTRL          = 8'h34,
    ADDR_W_IN_DATA_0        = 8'h38,
    ADDR_W_IN_CTRL          = 8'h3c,
    ADDR_KERNEL_SIZE_DATA_0 = 8'h40,
    ADDR_KERNEL_SIZE_CTRL   = 8'h44,
    ADDR_PADDING_DATA_0     = 8'h48,
    ADDR_PADDING_CTRL       = 8'h4c,
    ADDR_FEATURE_IN_DATA_0  = 8'h50,
    ADDR_FEATURE_IN_DATA_1  = 8'h54,
    ADDR_FEATURE_IN_CTRL    = 8'h58,
    ADDR_CONV_KERNEL_DATA_0 = 8'h5c,
    ADDR_CONV_KERNEL_DATA_1 = 8'h60,
    ADDR_CONV_KERNEL_CTRL   = 8'h64,
    ADDR_BN_MEAN_DATA_0     = 8'h68,
    ADDR_BN_MEAN_DATA_1     = 8'h6c,
    ADDR_BN_MEAN_CTRL       = 8'h70,
    ADDR_BN_VAR_DATA_0      = 8'h74,
    ADDR_BN_VAR_DATA_1      = 8'h78,
    ADDR_BN_VAR_CTRL        = 8'h7c,
    ADDR_BN_GAMMA_DATA_0    = 8'h80,
    ADDR_BN_GAMMA_DATA_1    = 8'h84,
    ADDR_BN_GAMMA_CTRL      = 8'h88,
    ADDR_BN_BETA_DATA_0     = 8'h8c,
    ADDR_BN_BETA_DATA_1     = 8'h90,
    ADDR_BN_BETA_CTRL       = 8'h94,
    ADDR_FEATURE_OUT_DATA_0 = 8'h98,
    ADDR_FEATURE_OUT_DATA_1 = 8'h9c,
    ADDR_FEATURE_OUT_CTRL   = 8'ha0,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_CONV_TYPE_DATA_0)
            int_conv_type[1:0] <= (WDATA[31:0] & wmask) | (int_conv_type[1:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_kernel_size[7:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_KERNEL_SIZE_DATA_0)
            int_kernel_size[7:0] <= (WDATA[31:0] & wmask) | (int_kernel_size[7:0] & ~wmask);
    end
end
