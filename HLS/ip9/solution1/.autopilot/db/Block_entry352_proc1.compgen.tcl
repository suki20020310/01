...
set id 103
set name conv_bn_relu_mux_42_64_1_1
...
set id 108
set name conv_bn_relu_mux_21_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set din0_width 32
...
set name conv_bn_relu_mul_29s_14ns_29_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name conv_bn_relu_mul_64ns_32ns_96_5_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 4 ALLOW_PRAGMA 1
}


set name conv_bn_relu_mul_30s_30s_30_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name conv_bn_relu_mul_24ns_30s_30_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name conv_bn_relu_mul_32s_18ns_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name conv_bn_relu_mul_32s_26ns_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name conv_bn_relu_mul_64ns_16ns_80_5_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 4 ALLOW_PRAGMA 1
}
...
set id 123
set name conv_bn_relu_mux_32_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set din0_width 32
...
set id 132
set name conv_bn_relu_mul_mul_16ns_8ns_24_4_1
...
set id 133
set name conv_bn_relu_mul_mul_16ns_16ns_32_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
set id 134
set name conv_bn_relu_mul_mul_24ns_17s_32_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 32
set arg_lists {i0 {24 0 +} i1 {17 1 +} p {32 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv_bn_relu_Block_entry352_proc1_bn_params_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv_bn_relu_Block_entry352_proc1_local_kernel_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv_bn_relu_Block_entry352_proc1_local_feature_in_blk_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv_bn_relu_Block_entry352_proc1_local_conv_kernel_blk_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv_type \
    op interface \
    ports { conv_type { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bn_gamma \
    op interface \
    ports { bn_gamma { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv_kernel \
    op interface \
    ports { conv_kernel { I 64 vector } } \
} "
}
