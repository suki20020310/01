...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename bn_params \
    op interface \
    ports { bn_params_address0 { O 7 vector } bn_params_ce0 { O 1 bit } bn_params_we0 { O 1 bit } bn_params_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_1 \
    op interface \
    ports { bn_params_1_address0 { O 7 vector } bn_params_1_ce0 { O 1 bit } bn_params_1_we0 { O 1 bit } bn_params_1_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_2 \
    op interface \
    ports { bn_params_2_address0 { O 7 vector } bn_params_2_ce0 { O 1 bit } bn_params_2_we0 { O 1 bit } bn_params_2_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_3 \
    op interface \
    ports { bn_params_3_address0 { O 7 vector } bn_params_3_ce0 { O 1 bit } bn_params_3_we0 { O 1 bit } bn_params_3_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_3'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln79_1 \
    op interface \
    ports { sext_ln79_1 { I 62 vector } } \
} "
}
