...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_4 \
    op interface \
    ports { bn_params_4_address0 { O 7 vector } bn_params_4_ce0 { O 1 bit } bn_params_4_we0 { O 1 bit } bn_params_4_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_4'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_5 \
    op interface \
    ports { bn_params_5_address0 { O 7 vector } bn_params_5_ce0 { O 1 bit } bn_params_5_we0 { O 1 bit } bn_params_5_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_5'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_6 \
    op interface \
    ports { bn_params_6_address0 { O 7 vector } bn_params_6_ce0 { O 1 bit } bn_params_6_we0 { O 1 bit } bn_params_6_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_6'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename bn_params_7 \
    op interface \
    ports { bn_params_7_address0 { O 7 vector } bn_params_7_ce0 { O 1 bit } bn_params_7_we0 { O 1 bit } bn_params_7_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'bn_params_7'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln205_1 \
    op interface \
    ports { sext_ln205_1 { I 62 vector } } \
} "
}
