set moduleName Block_entry352_proc1_Pipeline_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Block_entry352_proc1_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ local_feature_in_blk float 32 regular {array 144 { 0 3 } 0 1 }  }
	{ local_feature_in_blk_1 float 32 regular {array 144 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ local_feature_in_blk_address0 sc_out sc_lv 8 signal 0 } 
	{ local_feature_in_blk_ce0 sc_out sc_logic 1 signal 0 } 
	{ local_feature_in_blk_we0 sc_out sc_logic 1 signal 0 } 
	{ local_feature_in_blk_d0 sc_out sc_lv 32 signal 0 } 
	{ local_feature_in_blk_1_address0 sc_out sc_lv 8 signal 1 } 
	{ local_feature_in_blk_1_ce0 sc_out sc_logic 1 signal 1 } 
	{ local_feature_in_blk_1_we0 sc_out sc_logic 1 signal 1 } 
	{ local_feature_in_blk_1_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	local_feature_in_blk { ap_memory {  { local_feature_in_blk_address0 mem_address 1 8 }  { local_feature_in_blk_ce0 mem_ce 1 1 }  { local_feature_in_blk_we0 mem_we 1 1 }  { local_feature_in_blk_d0 mem_din 1 32 } } }
	local_feature_in_blk_1 { ap_memory {  { local_feature_in_blk_1_address0 mem_address 1 8 }  { local_feature_in_blk_1_ce0 mem_ce 1 1 }  { local_feature_in_blk_1_we0 mem_we 1 1 }  { local_feature_in_blk_1_d0 mem_din 1 32 } } }
}
