; ModuleID = 'C:/Users/11400/Desktop/shuffletest/HLS/ip9/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_conv_bn_relu_ir(%"struct.ap_uint<2>"* nocapture readonly %conv_type, %"struct.ap_uint<16>"* nocapture readonly %C_in, %"struct.ap_uint<16>"* nocapture readonly %H_in, %"struct.ap_uint<16>"* nocapture readonly %W_in, %"struct.ap_uint<16>"* nocapture readonly %C_out, %"struct.ap_uint<8>"* nocapture readonly %kernel_size, %"struct.ap_uint<8>"* nocapture readonly %stride, %"struct.ap_uint<8>"* nocapture readonly %padding, float* noalias nocapture nonnull readonly %feature_in, float* noalias nocapture nonnull readonly %conv_kernel, float* noalias nocapture nonnull readonly %bn_mean, float* noalias nocapture nonnull readonly %bn_var, float* noalias nocapture nonnull readonly %bn_gamma, float* noalias nocapture nonnull readonly %bn_beta, float* noalias nocapture nonnull %feature_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_conv_bn_relu_hw(%"struct.ap_uint<2>"* %conv_type, %"struct.ap_uint<16>"* %C_in, %"struct.ap_uint<16>"* %H_in, %"struct.ap_uint<16>"* %W_in, %"struct.ap_uint<16>"* %C_out, %"struct.ap_uint<8>"* %kernel_size, %"struct.ap_uint<8>"* %stride, %"struct.ap_uint<8>"* %padding, float* %7, float* %8, float* %9, float* %10, float* %11, float* %12, float* %13)
...
declare void @apatb_conv_bn_relu_hw(%"struct.ap_uint<2>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, float*, float*, float*, float*, float*, float*, float*)
...
define void @conv_bn_relu_hw_stub_wrapper(%"struct.ap_uint<2>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, float*, float*, float*, float*, float*, float*, float*) #4 {
entry:
  ...
  call void @conv_bn_relu_hw_stub(%"struct.ap_uint<2>"* %0, %"struct.ap_uint<16>"* %1, %"struct.ap_uint<16>"* %2, %"struct.ap_uint<16>"* %3, %"struct.ap_uint<16>"* %4, %"struct.ap_uint<8>"* %5, %"struct.ap_uint<8>"* %6, %"struct.ap_uint<8>"* %7, float* %22, float* %23, float* %24, float* %25, float* %26, float* %27, float* %28)
  call void @copy_in([2147483647 x float]* null, [2147483647 x float]* %15, [2147483647 x float]* null, [2147483647 x float]* %16, [2147483647 x float]* null, [2147483647 x float]* %17, [2147483647 x float]* null, [2147483647 x float]* %18, [2147483647 x float]* null, [2147483647 x float]* %19, [2147483647 x float]* null, [2147483647 x float]* %20, [2147483647 x float]* null, [2147483647 x float]* %21)
  ret void
}

declare void @conv_bn_relu_hw_stub(%"struct.ap_uint<2>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, float*, float*, float*, float*, float*, float*, float*)
