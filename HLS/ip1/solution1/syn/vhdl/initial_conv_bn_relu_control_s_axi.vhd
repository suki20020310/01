...
entity initial_conv_bn_relu_control_s_axi is
generic (
...
end entity initial_conv_bn_relu_control_s_axi;
...
architecture behave of initial_conv_bn_relu_control_s_axi is
    ...
    constant ADDR_W_IN_DATA_0         : INTEGER := 16#18#;
    constant ADDR_W_IN_CTRL           : INTEGER := 16#1c#;
    constant ADDR_K_DATA_0            : INTEGER := 16#20#;
    constant ADDR_K_CTRL              : INTEGER := 16#24#;
    constant ADDR_PADDING_DATA_0      : INTEGER := 16#28#;
    constant ADDR_PADDING_CTRL        : INTEGER := 16#2c#;
    constant ADDR_POOL_STRIDE_DATA_0  : INTEGER := 16#30#;
    constant ADDR_POOL_STRIDE_CTRL    : INTEGER := 16#34#;
    constant ADDR_H_IN_DATA_0         : INTEGER := 16#38#;
    constant ADDR_H_IN_CTRL           : INTEGER := 16#3c#;
    constant ADDR_C_OUT_DATA_0        : INTEGER := 16#40#;
    constant ADDR_C_OUT_CTRL          : INTEGER := 16#44#;
    constant ADDR_STRIDE_DATA_0       : INTEGER := 16#48#;
    constant ADDR_STRIDE_CTRL         : INTEGER := 16#4c#;
    constant ADDR_POOL_KERNEL_DATA_0  : INTEGER := 16#50#;
    constant ADDR_POOL_KERNEL_CTRL    : INTEGER := 16#54#;
    constant ADDR_POOL_PADDING_DATA_0 : INTEGER := 16#58#;
    constant ADDR_POOL_PADDING_CTRL   : INTEGER := 16#5c#;
    ...
    constant ADDR_CONV_KERNEL_DATA_0  : INTEGER := 16#6c#;
    constant ADDR_CONV_KERNEL_DATA_1  : INTEGER := 16#70#;
    constant ADDR_CONV_KERNEL_CTRL    : INTEGER := 16#74#;
    constant ADDR_BN_MEAN_DATA_0      : INTEGER := 16#78#;
    constant ADDR_BN_MEAN_DATA_1      : INTEGER := 16#7c#;
    constant ADDR_BN_MEAN_CTRL        : INTEGER := 16#80#;
    constant ADDR_BN_VAR_DATA_0       : INTEGER := 16#84#;
    constant ADDR_BN_VAR_DATA_1       : INTEGER := 16#88#;
    constant ADDR_BN_VAR_CTRL         : INTEGER := 16#8c#;
    constant ADDR_BN_GAMMA_DATA_0     : INTEGER := 16#90#;
    constant ADDR_BN_GAMMA_DATA_1     : INTEGER := 16#94#;
    constant ADDR_BN_GAMMA_CTRL       : INTEGER := 16#98#;
    constant ADDR_BN_BETA_DATA_0      : INTEGER := 16#9c#;
    constant ADDR_BN_BETA_DATA_1      : INTEGER := 16#a0#;
    constant ADDR_BN_BETA_CTRL        : INTEGER := 16#a4#;
    constant ADDR_FEATURE_OUT_DATA_0  : INTEGER := 16#a8#;
    constant ADDR_FEATURE_OUT_DATA_1  : INTEGER := 16#ac#;
    constant ADDR_FEATURE_OUT_CTRL    : INTEGER := 16#b0#;
    ...
    signal int_pool_kernel     : UNSIGNED(7 downto 0) := (others => '0');
    signal int_pool_padding    : UNSIGNED(7 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_POOL_KERNEL_DATA_0 =>
                        rdata_data <= RESIZE(int_pool_kernel(7 downto 0), 32);
                    when ADDR_POOL_PADDING_DATA_0 =>
                        rdata_data <= RESIZE(int_pool_padding(7 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    pool_kernel          <= STD_LOGIC_VECTOR(int_pool_kernel);
    pool_padding         <= STD_LOGIC_VECTOR(int_pool_padding);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_POOL_KERNEL_DATA_0) then
                    int_pool_kernel(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_pool_kernel(7 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_POOL_PADDING_DATA_0) then
                    int_pool_padding(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_pool_padding(7 downto 0));
                end if;
            end if;
        end if;
    end process;
