...
set Library     "hls"
set IPName      "initial_conv_bn_relu"
set Version     "1.0"
set DisplayName "Initial_conv_bn_relu"
set Revision    "2114326356"
...
set xo_kernel_name "initial_conv_bn_relu"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/11400/Desktop/shuffle/HLS/ip1/solution1"
set debug_dir "C:/Users/11400/Desktop/shuffle/HLS/ip1/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {initial_conv_bn_relu_udiv_32ns_16ns_17_36_1
...
initial_conv_bn_relu_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "initial_conv_bn_relu"
set TopNoPrefix "initial_conv_bn_relu"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 C_in W 0x0 "Data signal of C_in" {{0 16 C_in W 0 "Bit 15 to 0 of C_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 W_in W 0x0 "Data signal of W_in" {{0 16 W_in W 0 "Bit 15 to 0 of W_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 K W 0x0 "Data signal of K" {{0 8 K W 0 "Bit 7 to 0 of K"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 padding W 0x0 "Data signal of padding" {{0 8 padding W 0 "Bit 7 to 0 of padding"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 pool_stride W 0x0 "Data signal of pool_stride" {{0 8 pool_stride W 0 "Bit 7 to 0 of pool_stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 H_in W 0x0 "Data signal of H_in" {{0 16 H_in W 0 "Bit 15 to 0 of H_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 C_out W 0x0 "Data signal of C_out" {{0 16 C_out W 0 "Bit 15 to 0 of C_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 stride W 0x0 "Data signal of stride" {{0 8 stride W 0 "Bit 7 to 0 of stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 pool_kernel W 0x0 "Data signal of pool_kernel" {{0 8 pool_kernel W 0 "Bit 7 to 0 of pool_kernel"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 pool_padding W 0x0 "Data signal of pool_padding" {{0 8 pool_padding W 0 "Bit 7 to 0 of pool_padding"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 feature_in_1 W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 31 to 0 of feature_in"}}} {0x64 feature_in_2 W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 63 to 32 of feature_in"}}} {0x6c conv_kernel_1 W 0x0 "Data signal of conv_kernel" {{0 32 conv_kernel W 0 "Bit 31 to 0 of conv_kernel"}}} {0x70 conv_kernel_2 W 0x0 "Data signal of conv_kernel" {{0 32 conv_kernel W 0 "Bit 63 to 32 of conv_kernel"}}} {0x78 bn_mean_1 W 0x0 "Data signal of bn_mean" {{0 32 bn_mean W 0 "Bit 31 to 0 of bn_mean"}}} {0x7c bn_mean_2 W 0x0 "Data signal of bn_mean" {{0 32 bn_mean W 0 "Bit 63 to 32 of bn_mean"}}} {0x84 bn_var_1 W 0x0 "Data signal of bn_var" {{0 32 bn_var W 0 "Bit 31 to 0 of bn_var"}}} {0x88 bn_var_2 W 0x0 "Data signal of bn_var" {{0 32 bn_var W 0 "Bit 63 to 32 of bn_var"}}} {0x90 bn_gamma_1 W 0x0 "Data signal of bn_gamma" {{0 32 bn_gamma W 0 "Bit 31 to 0 of bn_gamma"}}} {0x94 bn_gamma_2 W 0x0 "Data signal of bn_gamma" {{0 32 bn_gamma W 0 "Bit 63 to 32 of bn_gamma"}}} {0x9c bn_beta_1 W 0x0 "Data signal of bn_beta" {{0 32 bn_beta W 0 "Bit 31 to 0 of bn_beta"}}} {0xa0 bn_beta_2 W 0x0 "Data signal of bn_beta" {{0 32 bn_beta W 0 "Bit 63 to 32 of bn_beta"}}} {0xa8 feature_out_1 W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 31 to 0 of feature_out"}}} {0xac feature_out_2 W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 63 to 32 of feature_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
