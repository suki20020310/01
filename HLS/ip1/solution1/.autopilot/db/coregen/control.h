...
#define CONTROL_BITS_K_DATA            8
#define CONTROL_ADDR_PADDING_DATA      0x28
#define CONTROL_BITS_PADDING_DATA      8
#define CONTROL_ADDR_POOL_STRIDE_DATA  0x30
#define CONTROL_BITS_POOL_STRIDE_DATA  8
#define CONTROL_ADDR_H_IN_DATA         0x38
#define CONTROL_BITS_H_IN_DATA         16
#define CONTROL_ADDR_C_OUT_DATA        0x40
#define CONTROL_BITS_C_OUT_DATA        16
#define CONTROL_ADDR_STRIDE_DATA       0x48
#define CONTROL_BITS_STRIDE_DATA       8
#define CONTROL_ADDR_POOL_KERNEL_DATA  0x50
#define CONTROL_BITS_POOL_KERNEL_DATA  8
#define CONTROL_ADDR_POOL_PADDING_DATA 0x58
#define CONTROL_BITS_POOL_PADDING_DATA 8
#define CONTROL_ADDR_FEATURE_IN_DATA   0x60
#define CONTROL_BITS_FEATURE_IN_DATA   64
#define CONTROL_ADDR_CONV_KERNEL_DATA  0x6c
#define CONTROL_BITS_CONV_KERNEL_DATA  64
#define CONTROL_ADDR_BN_MEAN_DATA      0x78
#define CONTROL_BITS_BN_MEAN_DATA      64
#define CONTROL_ADDR_BN_VAR_DATA       0x84
#define CONTROL_BITS_BN_VAR_DATA       64
#define CONTROL_ADDR_BN_GAMMA_DATA     0x90
#define CONTROL_BITS_BN_GAMMA_DATA     64
#define CONTROL_ADDR_BN_BETA_DATA      0x9c
#define CONTROL_BITS_BN_BETA_DATA      64
#define CONTROL_ADDR_FEATURE_OUT_DATA  0xa8
