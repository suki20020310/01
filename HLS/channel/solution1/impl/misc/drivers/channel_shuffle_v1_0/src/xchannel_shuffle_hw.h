...
#define XCHANNEL_SHUFFLE_CONTROL_ADDR_DATA_IN_DATA  0x28
#define XCHANNEL_SHUFFLE_CONTROL_BITS_DATA_IN_DATA  64
#define XCHANNEL_SHUFFLE_CONTROL_ADDR_DATA_OUT_DATA 0x34
#define XCHANNEL_SHUFFLE_CONTROL_BITS_DATA_OUT_DATA 64
