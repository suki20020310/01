...
#line 16 "C:/Users/11400/Desktop/shuffletest/HLS/channel/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=channel_shuffle
# 18 "../ip/ip6/channel_shuffle.cpp"


#pragma HLS INTERFACE m_axi depth=2147483647 port=data_out bundle=gmem0 offset=slave
#pragma HLS INTERFACE m_axi depth=2147483647 port=data_in bundle=gmem0 offset=slave


#pragma HLS INTERFACE s_axilite port=return
#pragma HLS INTERFACE s_axilite port=c_in offset=0x10
#pragma HLS INTERFACE s_axilite port=h_w offset=0x20
#pragma HLS INTERFACE s_axilite port=groups offset=0x18
 ...
 if (c_in % groups != 0) {
    ...
    VITIS_LOOP_40_1: for (ap_uint<16> h_block = 0; h_block < h_w; h_block += 8) {
        VITIS_LOOP_41_2: for (ap_uint<16> w_block = 0; w_block < h_w; w_block += 8) {
            VITIS_LOOP_42_3: for (ap_uint<16> h = h_block; h < h_block + 8 && h < h_w; h++) {
                VITIS_LOOP_43_4: for (ap_uint<16> w = w_block; w < w_block + 8 && w < h_w; w++) {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_45_5: for (ap_uint<8> g = 0; g < groups; g++) {
#pragma HLS UNROLL factor=4
 VITIS_LOOP_47_6: for (ap_uint<16> c = 0; c < group_ch; c++) {
