...
entity fully_connected_control_s_axi is
generic (
...
end entity fully_connected_control_s_axi;
...
architecture behave of fully_connected_control_s_axi is
    ...
    constant ADDR_IN_FEATURES_DATA_0  : INTEGER := 16#10#;
    constant ADDR_IN_FEATURES_CTRL    : INTEGER := 16#14#;
    constant ADDR_OUT_FEATURES_DATA_0 : INTEGER := 16#18#;
    constant ADDR_OUT_FEATURES_CTRL   : INTEGER := 16#1c#;
    ...
    constant ADDR_BIASES_DATA_0       : INTEGER := 16#38#;
    constant ADDR_BIASES_DATA_1       : INTEGER := 16#3c#;
    constant ADDR_BIASES_CTRL         : INTEGER := 16#40#;
    constant ADDR_OUTPUT_R_DATA_0     : INTEGER := 16#44#;
    constant ADDR_OUTPUT_R_DATA_1     : INTEGER := 16#48#;
    constant ADDR_OUTPUT_R_CTRL       : INTEGER := 16#4c#;
    ...
    signal int_in_features     : UNSIGNED(15 downto 0) := (others => '0');
    signal int_out_features    : UNSIGNED(15 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_IN_FEATURES_DATA_0 =>
                        rdata_data <= RESIZE(int_in_features(15 downto 0), 32);
                    when ADDR_OUT_FEATURES_DATA_0 =>
                        rdata_data <= RESIZE(int_out_features(15 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    in_features          <= STD_LOGIC_VECTOR(int_in_features);
    out_features         <= STD_LOGIC_VECTOR(int_out_features);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IN_FEATURES_DATA_0) then
                    int_in_features(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_in_features(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUT_FEATURES_DATA_0) then
                    int_out_features(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_out_features(15 downto 0));
                end if;
            end if;
        end if;
    end process;
