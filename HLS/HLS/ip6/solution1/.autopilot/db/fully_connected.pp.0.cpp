...
# 2 "<built-in>" 2
# 1 "../ip/ip6/fully_connected.cpp" 2
# 1 "../ip/ip6/fully_connected.h" 1
...
# 5 "../ip/ip6/fully_connected.h" 2


typedef float Dtype_f;
typedef float Dtype_w;
typedef float Dtype_acc;
# 25 "../ip/ip6/fully_connected.h"
__attribute__((sdx_kernel("fully_connected", 0))) void fully_connected(
...
# 2 "../ip/ip6/fully_connected.cpp" 2
...
#line 16 "C:/Users/11400/Desktop/shuffletest/HLS/ip6/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fully_connected
# 20 "../ip/ip6/fully_connected.cpp"

#line 6 "C:/Users/11400/Desktop/shuffletest/HLS/ip6/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fully_connected
# 20 "../ip/ip6/fully_connected.cpp"


#pragma HLS INTERFACE m_axi port=input bundle=gmem0 depth=1024*1024*1024
#pragma HLS INTERFACE m_axi port=weights bundle=gmem0 depth=1024*1024*1024
#pragma HLS INTERFACE m_axi port=biases bundle=gmem0 depth=1024*1024
#pragma HLS INTERFACE m_axi port=output bundle=gmem0 depth=1024*1024


#pragma HLS INTERFACE s_axilite port=return bundle=control
#pragma HLS INTERFACE s_axilite port=in_features bundle=control offset=0x10
#pragma HLS INTERFACE s_axilite port=out_features bundle=control offset=0x14



#pragma HLS PIPELINE II=1
 VITIS_LOOP_35_1: for (int o = 0; o < out_features; ++o) {
...
#pragma HLS UNROLL factor=8 skip_exit_check
 VITIS_LOOP_42_2: for (int i = 0; i < in_features; ++i) {

            int w_offset = o * in_features + i;


            sum += (Dtype_acc)input[i] * (Dtype_acc)weights[w_offset];
        }


        sum += (Dtype_acc)biases[o];


        output[o] = (Dtype_f)(sum);
    }
}
