...
#pragma HLS INTERFACE s_axilite port=h_w bundle=control offset=0x14
#pragma HLS INTERFACE s_axilite port=groups bundle=control offset=0x18
 ...
 const ap_uint<16> group_ch = c_in / groups;
    ...
    VITIS_LOOP_32_1: for (ap_uint<16> h = 0; h < h_w; h++) {
        VITIS_LOOP_33_2: for (ap_uint<16> w = 0; w < h_w; w++) {
#pragma HLS PIPELINE II=1

 VITIS_LOOP_36_3: for (ap_uint<8> g = 0; g < groups; g++) {
                VITIS_LOOP_37_4: for (ap_uint<16> c = 0; c < group_ch; c++) {
