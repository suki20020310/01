...
entry:
  ...
  %in_copy = bitcast i8* %malloccall to [1073741824 x float]*
  %malloccall1 = tail call i8* @malloc(i64 4294967296)
  %out_copy = bitcast i8* %malloccall1 to [1073741824 x float]*
  %0 = bitcast float* %in to [1073741824 x float]*
  %1 = bitcast float* %out to [1073741824 x float]*
  call fastcc void @copy_in([1073741824 x float]* nonnull %0, [1073741824 x float]* %in_copy, [1073741824 x float]* nonnull %1, [1073741824 x float]* %out_copy)
  %2 = getelementptr inbounds [1073741824 x float], [1073741824 x float]* %in_copy, i32 0, i32 0
  %3 = getelementptr inbounds [1073741824 x float], [1073741824 x float]* %out_copy, i32 0, i32 0
  call void @apatb_channel_shuffle_hw(%"struct.ap_uint<16>"* %c_in, %"struct.ap_uint<16>"* %h_w, %"struct.ap_uint<8>"* %groups, float* %2, float* %3)
  call void @copy_back([1073741824 x float]* %0, [1073741824 x float]* %in_copy, [1073741824 x float]* %1, [1073741824 x float]* %out_copy)
...
entry:
  %5 = bitcast float* %3 to [1073741824 x float]*
  %6 = bitcast float* %4 to [1073741824 x float]*
  call void @copy_out([1073741824 x float]* null, [1073741824 x float]* %5, [1073741824 x float]* null, [1073741824 x float]* %6)
  %7 = bitcast [1073741824 x float]* %5 to float*
  %8 = bitcast [1073741824 x float]* %6 to float*
  call void @channel_shuffle_hw_stub(%"struct.ap_uint<16>"* %0, %"struct.ap_uint<16>"* %1, %"struct.ap_uint<8>"* %2, float* %7, float* %8)
  call void @copy_in([1073741824 x float]* null, [1073741824 x float]* %5, [1073741824 x float]* null, [1073741824 x float]* %6)
  ret void
}
