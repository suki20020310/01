...
#define XCHANNEL_SHUFFLE_CONTROL_ADDR_IN_R_DATA   0x28
#define XCHANNEL_SHUFFLE_CONTROL_BITS_IN_R_DATA   64
#define XCHANNEL_SHUFFLE_CONTROL_ADDR_OUT_R_DATA  0x34
#define XCHANNEL_SHUFFLE_CONTROL_BITS_OUT_R_DATA  64
