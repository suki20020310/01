...
set Library     "hls"
set IPName      "output_conv_pool_bn"
set Version     "1.0"
set DisplayName "Output_conv_pool_bn"
set Revision    "2114326378"
...
set xo_kernel_name "output_conv_pool_bn"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/11400/Desktop/shuffle/HLS/ip4/solution1"
set debug_dir "C:/Users/11400/Desktop/shuffle/HLS/ip4/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {output_conv_pool_bn_sdiv_32ns_32ns_32_36_1
...
## Variables
set Top "output_conv_pool_bn"
set TopNoPrefix "output_conv_pool_bn"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 c_in W 0x0 "Data signal of c_in" {{0 16 c_in W 0 "Bit 15 to 0 of c_in"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 h_w W 0x0 "Data signal of h_w" {{0 16 h_w W 0 "Bit 15 to 0 of h_w"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 in_r_1 W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 31 to 0 of in_r"}}} {0x24 in_r_2 W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 63 to 32 of in_r"}}} {0x2c conv_kernel_1 W 0x0 "Data signal of conv_kernel" {{0 32 conv_kernel W 0 "Bit 31 to 0 of conv_kernel"}}} {0x30 conv_kernel_2 W 0x0 "Data signal of conv_kernel" {{0 32 conv_kernel W 0 "Bit 63 to 32 of conv_kernel"}}} {0x38 bn_mean_1 W 0x0 "Data signal of bn_mean" {{0 32 bn_mean W 0 "Bit 31 to 0 of bn_mean"}}} {0x3c bn_mean_2 W 0x0 "Data signal of bn_mean" {{0 32 bn_mean W 0 "Bit 63 to 32 of bn_mean"}}} {0x44 bn_var_1 W 0x0 "Data signal of bn_var" {{0 32 bn_var W 0 "Bit 31 to 0 of bn_var"}}} {0x48 bn_var_2 W 0x0 "Data signal of bn_var" {{0 32 bn_var W 0 "Bit 63 to 32 of bn_var"}}} {0x50 bn_gamma_1 W 0x0 "Data signal of bn_gamma" {{0 32 bn_gamma W 0 "Bit 31 to 0 of bn_gamma"}}} {0x54 bn_gamma_2 W 0x0 "Data signal of bn_gamma" {{0 32 bn_gamma W 0 "Bit 63 to 32 of bn_gamma"}}} {0x5c bn_beta_1 W 0x0 "Data signal of bn_beta" {{0 32 bn_beta W 0 "Bit 31 to 0 of bn_beta"}}} {0x60 bn_beta_2 W 0x0 "Data signal of bn_beta" {{0 32 bn_beta W 0 "Bit 63 to 32 of bn_beta"}}} {0x68 fc_weights_1 W 0x0 "Data signal of fc_weights" {{0 32 fc_weights W 0 "Bit 31 to 0 of fc_weights"}}} {0x6c fc_weights_2 W 0x0 "Data signal of fc_weights" {{0 32 fc_weights W 0 "Bit 63 to 32 of fc_weights"}}} {0x74 fc_biases_1 W 0x0 "Data signal of fc_biases" {{0 32 fc_biases W 0 "Bit 31 to 0 of fc_biases"}}} {0x78 fc_biases_2 W 0x0 "Data signal of fc_biases" {{0 32 fc_biases W 0 "Bit 63 to 32 of fc_biases"}}} {0x80 out_r_1 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 of out_r"}}} {0x84 out_r_2 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 63 to 32 of out_r"}}} {0x8c c_out W 0x0 "Data signal of c_out" {{0 16 c_out W 0 "Bit 15 to 0 of c_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x94 num_classes W 0x0 "Data signal of num_classes" {{0 16 num_classes W 0 "Bit 15 to 0 of num_classes"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
